...
// thực hineje gọi id và các wiget
    ...
    private void initSearchView() {
        // thuwhc hiện chỉnh suera ..v ..v ..v hay vừa ấn vừa thực hiện một cía gì đó
    ...
    // thuhc hiện gửi truy vấn
    private void onSubmitQuery() {
        // thực hiện lấy dữ liệu tu editext khac rong thif
        CharSequence query = mSearchSrcTextView.getText();
        // neu nhu editext khac rong thif  hoa gia tri cua no lon hon khon
        if (query != null && TextUtils.getTrimmedLength(query) > 0) {
            // neu nhue
            // thục hinje iểm tra dữ liệu nêu như cái query gì đáy bằng rổng hoặc giá trị của query là rổng false thì   đóng nó đ
    ...
    /**
     * Set efood.com.food.Adapter for suggestions list. Should implement Filterable.
     *
     * @param adapter
     */
